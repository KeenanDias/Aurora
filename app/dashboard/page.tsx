      ...
      <main className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8 flex items-end justify-between">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-white/10 text-white/50 text-sm font-medium hover:bg-white/[0.04] hover:text-white/70 transition-all"
          >
